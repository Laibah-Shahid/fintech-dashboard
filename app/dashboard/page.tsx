...
const DashboardPage = () => {
  ...
  const [loading, setLoading] = useState({ accounts: true, transactions: true });
          ...
          <CardContent className="pt-6">
            <div className="flex flex-col md:flex-row items-center">
              <div className="flex-1 mb-4 md:mb-0">
                <h3 className="text-xl font-semibold mb-2">Subscribe to Access All Features</h3>
                <p className="text-gray-400">
                  You need a subscription to use the FinAPI sandbox features. Choose a plan to continue.
                </p>
              </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <Card className="bg-secondary/20">
          <CardHeader>
            ...
            <CardDescription>View your past activity</CardDescription>
          </CardHeader>
          <CardContent className="pt-2">
            <Button asChild className="w-full bg-fintech-purple hover:bg-fintech-purple/90">
              <Link href="/dashboard/transactions">
        ...
        <Card className="bg-secondary/20">
          <CardHeader>
            ...
            <CardDescription>Create custom invoices</CardDescription>
          </CardHeader>
          <CardContent className="pt-2">
            <Button asChild className="w-full bg-fintech-purple hover:bg-fintech-purple/90">
