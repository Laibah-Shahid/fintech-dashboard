...
import { useAuth } from "@/contexts/AuthContext"; // Make sure this works in Next.js
    ...
    <div className="min-h-screen flex flex-col justify-center items-center bg-fintech-dark-purple p-4">
      <div className="w-full max-w-md">
        <div className="mb-8 text-center">
          ...
          <p className="mt-2 text-gray-400">Log in to continue to FinAPI sandbox</p>
        </div>
        ...
        <div className="bg-secondary/30 backdrop-blur-sm rounded-xl p-8 border border-white/5 shadow-xl">
          ...
          <div className="mt-6 text-center text-sm">
            <p className="text-gray-400">
              ...
              <Link href="/register" className="text-fintech-purple hover:underline">
                Register
              </Link>
            </p>
          </div>
